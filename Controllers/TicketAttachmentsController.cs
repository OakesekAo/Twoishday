...
namespace Twoishday.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Created,UserId,Description,FileName,FileDate,FileContentType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Created,UserId,Description,FileName,FileDate,FileContentType")] TicketAttachment ticketAttachment)
        {
